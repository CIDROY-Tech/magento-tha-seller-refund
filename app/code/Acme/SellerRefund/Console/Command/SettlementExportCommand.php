...
class SettlementExportCommand extends Command
{
    ...
    public function __construct(
        ...
        private readonly SettlementAdjustmentExporter $exporter,
        ?string $name = null
    ) {
    ...
    {
        $this->setName('acme:refund:settlement-export')
            ->setDescription('Print the settlement adjustment export for one refund.')
